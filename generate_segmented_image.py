...
def concat_segmented_image(result_dir, scale=1):
    ...
    # set the text
    col_names = ["Image", "Ground Truth", "U-Net", "AttU-Net", "CA-Net", "CE-Net", "CPF-Net", "CKDNet", "SwinUnet", "DATransUNet", "LiteFANet"]
    row_names = ["a)", "b)", "c)"]
...
if __name__ == "__main__":
    ...
    #     "Kvasir-SEG",
    #     ["UNet", "AttU_Net", "CANet", "CENet", "CPFNet", "CKDNet", "SwinUnet", "DATransUNet", "LiteFANet"]
    # )
    ...
    generate_tooth_segment_result_images(["UNet3D", "DenseVNet", "AttentionUNet3D", "DenseVoxelNet", "MultiResUNet3D", "UNETR", "SwinUNETR", "TransBTS", "nnFormer", "3DUXNet", "LiteFANet"])
