...
class SpatialGate(nn.Module):
    def __init__(self):
        ...
        self.spatial = UltraConv(2, 1, kernel_size, stride=1, padding=(kernel_size - 1) // 2, relu=False)
...
class SpatialAtten(nn.Module):
    def __init__(self, in_size, out_size, kernel_size=3, stride=1):
        ...
        self.conv1 = UltraConv(in_size, out_size, kernel_size, stride=stride,
                               padding=(kernel_size - 1) // 2, relu=True)
        self.conv2 = UltraConv(out_size, out_size, kernel_size=1, stride=stride,
