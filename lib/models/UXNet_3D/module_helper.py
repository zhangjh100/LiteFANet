...
class ModuleHelper(object):
    ...
    def BNReLU(num_features, bn_type=None, **kwargs):
        if bn_type == 'torchbn':
            ...
            from lib.models.UXNet_3D.extensions.syncbn.module import BatchNorm2d
            return nn.Sequential(
                BatchNorm2d(num_features, **kwargs),
                nn.ReLU()
            )
        elif bn_type == 'sn':
            from lib.models.UXNet_3D.extensions.switchablenorms.switchable_norm import SwitchNorm2d
            return nn.Sequential(
            ...
            if torch_ver == '0.4':
                from lib.models.UXNet_3D.extensions.inplace_abn.bn import InPlaceABNSync
                return InPlaceABNSync(num_features, **kwargs)
            elif torch_ver in ('1.0', '1.1'):
                from lib.models.UXNet_3D.extensions.inplace_abn_1.bn import InPlaceABNSync
                return InPlaceABNSync(num_features, **kwargs)
